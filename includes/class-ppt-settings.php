...
class PPT_Settings {
	...
	public function field_cta_tier( array $args ): void {
		...
		echo '<input type="text" name="' . esc_attr( PPT_OPTION_KEY ) . '[cta_' . esc_attr( $tier ) . '_class]" value="' . $class . '" placeholder="e.g. btn--action" class="regular-text" />';
		echo '</div>';
		echo '<div>';
		...
		echo '<input type="text" name="' . esc_attr( PPT_OPTION_KEY ) . '[cta_' . esc_attr( $tier ) . '_label]" value="' . $label . '" placeholder="e.g. Primary CTA" class="regular-text" />';
		echo '</div>';
		echo '</div>';
